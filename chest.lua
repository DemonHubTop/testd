...
Commands = {
    ...
    '[86] crash -- Uses harkinians script to crash server',
...
adminversion = "BrookHaven Admin by Jova, V1"
...
lplayer.Chatted:Connect(function(msg)
    ...
    if string.sub(msg, 1, 8) == (prefix.."fecheck") then
        if game:GetService("Workspace").FilteringEnabled == true then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
                Title = "FE is Enabled";
                Text = "Filtering Enabled. Enjoy using BrookHaven Admin!";
            })
        else
...
CMDBAR.FocusLost:connect(function(enterPressed)
    if enterPressed then
        ...
        if string.sub(CMDBAR.Text, 1, 8) == ("crash") then
            game:GetService'RunService'.Stepped:Connect(function()
            pcall(function()
                for i,v in pairs(game:GetService'Players':GetPlayers()) do
                    if v.Character ~= nil and v.Character:FindFirstChild'Head' then
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Attempting Crash";
            Text = "Crash Attempt has begun.";
            })
        end
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    ...
    Text = "Brookhaven Admin V2 by Tubers93";
})
wait(0.1)
print("BrookHaven Admin V2 loaded!")
if game:GetService("Workspace").FilteringEnabled == true then
    warn("FE is Enabled (Filtering Enabled)")
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "FE is Enabled";
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=7406687373"
